 ...
 * to the tiles from the root directory.
 * <P>
 * The ZoomLevelMaker class has the properties used to create ZoomLevelInfo
 * objects.
 * 
 * @author dietrick
 */
public class ZoomLevelInfo extends OMComponent {
	...
	/**
	 * Given a bounds containing a lat/lon box (x, y, w, h in decimal degrees) and a
	 * transform for the MapTileCoordinates being used for the tiles (OpenStreetMap
	 * or Google (MTS)), provide the UV tile coordinates for the the bounding box.
	 * 
	...
	/**
	 * Creates the parent directory of the file with the current zoom level set in
	 * the ZoomLevelInfo.
	 * 
	 * @param rootDir path to root of dir structire, with no file separator at the
	 *                end.
	 ...
	 * Ready for file extension, which should have a period on it.
	 * 
	 * @param rootDir path to root of dir structure, with no file separator at the
	 *                end.
