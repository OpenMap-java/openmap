...
public class EventListCellRenderer extends OMComponentPanel implements ListCellRenderer<OMEvent> {
	...
	public void setProperties(String prefix, Properties props) {
		...
		fontColor = PropUtils.parseColorFromProperties(props, prefix + FontColorProperty, fontColor);
		altFontColor = PropUtils.parseColorFromProperties(props, prefix + AltFontColorProperty, altFontColor);
		selectColor = PropUtils.parseColorFromProperties(props, prefix + SelectColorProperty, selectColor);
		timeWindowColor = PropUtils.parseColorFromProperties(props, prefix + TimeWindowColorProperty, timeWindowColor);
		regularBackgroundColor = PropUtils.parseColorFromProperties(props, prefix + BackgroundColorProperty,
