...
public class MenuBar extends JMenuBar implements Serializable, BeanContextMembershipListener, BeanContextChild {
	...
	/**
	 * Called when the MenuBar is a part of a BeanContext, and it is added to
	 * the BeanContext, or while other objects are added to the BeanContext
	 * after that.
	 * 
	 * @param it Iterator
	 */
	...
	/**
	 * Get the last menu item on the menu bar. If there are no menu items, it
	 * returns null.
	 */
