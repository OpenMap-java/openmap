...
public class EditorLayer extends DrawingToolLayer implements Tool {
	...
	/**
	 * Set whether the face of the EditorTool should be on the palette for the
	 * layer (via getGUI). False by default.
	 */
	public final static String FACE_ON_PALETTE_PROPERTY = "faceOnPalette";

	protected int orientation = SwingConstants.HORIZONTAL;
	protected boolean faceOnPalette = false;
	...
	public void setProperties(String prefix, Properties props) {
		...
		setFaceOnPalette(PropUtils.booleanFromProperties(props,  realPrefix + FACE_ON_PALETTE_PROPERTY, isFaceOnPalette()));
		...
		if (editorTool == null) {
			...
			if (editorClassName != null) {
				...
				if (editorTool == null) {
					...
					Debug.error(getName() + " doesn't have a EditorTool defined" + additionalInfo);
				}
			}
		}
	}
	...
	/**
	 * @return the faceOnPalette
	 */
	public boolean isFaceOnPalette() {
		return faceOnPalette;
	}

	/**
	 * @param faceOnPalette the faceOnPalette to set
	 */
	public void setFaceOnPalette(boolean faceOnPalette) {
		this.faceOnPalette = faceOnPalette;
	}
