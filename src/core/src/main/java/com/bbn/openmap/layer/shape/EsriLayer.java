 ...
 *         interaction.
 */
public class EsriLayer extends OMGraphicHandlerLayer implements ShapeConstants, DataBoundsProvider {
    ...
    /**
     * Standard OMGraphicHandlerLayer prepare called when the projection
     * changes.
     * 
