...
public class GraphicAttributes extends DrawingAttributes implements ActionListener, Serializable, OMGraphicConstants {
	 ...
	 * 
	 * @param graphic
	 *            OMGraphic to gather settings from.
	 * @param resetGUI
	 *            flag to cause GraphicAttribute GUI reset.
	 */
	 ...
	 *            OMGraphic.
	 * @param resetGUI
	 *            reset the GraphicAttributes GUI if desired.
	 */
	...
	public JMenu getLineTypeMenu() {
		...
		if (renderType == RENDERTYPE_LATLON && enableLineTypeChoice) {
			...
			JRadioButtonMenuItem button = new JRadioButtonMenuItem(
					i18n.get(DrawingAttributes.class, "Great_Circle", "Great Circle"),
					lineType == LineType.GreatCircle);
			button.setActionCommand(String.valueOf(LineType.GreatCircle));
			button.addActionListener(listener);
			lineTypeMenu.add(button);

			button = new JRadioButtonMenuItem(i18n.get(GraphicAttributes.class, "Rhumb", "Rhumb"),
			...
			button = new JRadioButtonMenuItem(i18n.get(GraphicAttributes.class, "Straight", "Straight"),
