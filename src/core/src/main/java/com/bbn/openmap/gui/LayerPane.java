...
public class LayerPane extends JPanel implements Serializable, ActionListener, ComponentListener {
	...
	protected AbstractButton getOnOffButton() {
		...
		String interString = i18n.get(LayerPane.class, "onoffButton.tooltip", "Turn \"{0}\" layer on/off",
				layer.getName());
	...
	protected AbstractButton getPaletteButton() {
		...
		String interString;
		if (!layer.hasGUI()) {
			interString = i18n.get(LayerPane.class, "paletteButton.noPaletteAvailable.tooltip",
					"No tools available for \"{0}\" layer", layer.getName());
			paletteButton.setEnabled(false);
		} else {
			interString = i18n.get(LayerPane.class, "paletteButton.paletteAvailable.tooltip",
					"Display tools for \"{0}\" layer", layer.getName());
		}
	...
	public void setSelected(boolean select) {
		...
		if (logger.isLoggable(Level.FINE)) {
			logger.fine("LayerPane for " + getLayer().getName() + " " + command + ", firing event");
		}
	...
	public void componentShown(ComponentEvent e) {
		if (logger.isLoggable(Level.FINE)) {
			logger.fine("layer pane for " + layer.getName() + " receiving componentShown event");
		}
	...
	public void componentHidden(ComponentEvent e) {
		if (logger.isLoggable(Level.FINE)) {
			logger.fine("layer pane for " + layer.getName() + " receiving componentHidden event");
		}
		Component comp = e.getComponent();
