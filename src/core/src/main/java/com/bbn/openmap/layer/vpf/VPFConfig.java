...
public class VPFConfig extends JPanel implements ActionListener {
	...
	protected void loadCurrentFeatures(DefaultMutableTreeNode top, String featureName,
	...
	private void addPropertiesForFeature(DefaultMutableTreeNode featureNode, String propertyPrefix,
	...
	public static void main(String[] args) {
		...
		argParser.add("features", "print available feature codes and descriptions, given paths to VPF directories",
				ArgParser.TO_END);
