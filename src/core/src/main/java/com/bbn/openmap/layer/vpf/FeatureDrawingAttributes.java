...
public class FeatureDrawingAttributes extends DrawingAttributes {
	 ...
	 */
	protected JComboBox<FCIChoice> attributeJCB;
	/**
	 * The GUI combo box for choices on how to display the attributes.
	 */
	protected JComboBox<DisplayTypeChoice> displayTypeJCB;
	/**
	 * The chosen display type, which gets set as a property in each OMGraphic for
	 * retrieval by the layer.
	 */
	...
	/**
	 * Retrieve the column index number out of the feature class info file that is
	 * being used/displayed.
	 * 
	...
	public Component getGUI() {
		if (guiPanel == null) {
			...
			attributePanel.setBorder(
					BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(), " Attribute Control "));
			...
			attributeJCB = new JComboBox<FCIChoice>();
			...
			attributeJCB.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent ae) {
					...
					JComboBox<FCIChoice> jcb = (JComboBox<FCIChoice>) ae.getSource();
			...
			DisplayTypeChoice[] dtc = new DisplayTypeChoice[] { new DisplayTypeChoice("None", null),
			...
			displayTypeJCB = new JComboBox<DisplayTypeChoice>(dtc);
			displayTypeJCB.setToolTipText("Choose how to display the attribute.");
			displayTypeJCB.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent ae) {
					@SuppressWarnings("unchecked")
					JComboBox<DisplayTypeChoice> jcb = (JComboBox<DisplayTypeChoice>) ae.getSource();
