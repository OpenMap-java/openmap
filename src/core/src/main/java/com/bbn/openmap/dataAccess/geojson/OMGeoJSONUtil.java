...
public class OMGeoJSONUtil {
	...
	/**
	 * Convert a List of LngLatAlt objects to an array alternating lat/lon radian values.
	 * @param lla List of LngLatAlt
	 * @return double array radians
	 */
	...
	/**
	 * Convert a List of LngLatAlt objects to an array alternating lat/lon decimal degree values.
	 * @param lla List of LngLatAlt
	 * @return double array decimal degrees
	 */    
