...
/**
 * This layer asks for an image from an OpenGIS compliant Web Map Server (WMS).
 ...
 */
public class WMSLayer extends WebImageLayer {
    ...
    public void setImageQuality(int newImageQuality) {
        if (newImageQuality == WMSLayer.LOSSY_IMAGE_QUALITY_HIGH)
            imageQuality = "HIGH";
        else if (newImageQuality == WMSLayer.LOSSY_IMAGE_QUALITY_MEDIUM)
            imageQuality = "MEDIUM";
        else if (newImageQuality == WMSLayer.LOSSY_IMAGE_QUALITY_LOW)
            imageQuality = "LOW";
    }
