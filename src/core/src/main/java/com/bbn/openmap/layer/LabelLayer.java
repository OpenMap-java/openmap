...
/**
 * Layer that displays a label. This Layer is a Taskable (ActionListener) object
 * so that it can be prompted by a javax.swing.Timer object. This layer
 ...
 * </pre>
 * <p>
 * In addition to the previous properties, you can get this layer to work with
 * the OpenMap viewer by adding/editing the additional properties in your
 * <code>openmap.properties</code> file:
 * <p>
 * 
 * <pre>
 * 
 ...
 * </pre>
 * <p>
 * NOTE: the color properties do not support alpha value if running on JDK
 * 1.1...
 */
public class LabelLayer extends OMGraphicHandlerLayer implements Taskable, MapMouseListener {
	...
	public void setProperties(String prefix, Properties props) {
		...
		fgColor = ColorFactory.parseColorFromProperties(props, prefix + fgColorProperty,
				Integer.toString(fgColorValue));

		bgColor = ColorFactory.parseColorFromProperties(props, prefix + bgColorProperty,
				Integer.toString(bgColorValue));
	...
	// Part of a small hack to get LabelLayer working in background mode. Will
	// be removed when layer is updated.
	private OMGraphicList hackList = new OMGraphicList();
