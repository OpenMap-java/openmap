...
public class LayersPanel extends OMToolComponent
	...
	public void createPanel(Layer[] inLayers) {
		...
		if (scrollPane == null) {
			scrollPane = new JScrollPane(panesPanel, ScrollPaneConstants.VERTICAL_SCROLLBAR_AS_NEEDED,
	...
	public Properties getPropertyInfo(Properties props) {
		...
		String interString = i18n.get(LayersPanel.class, ControlButtonsProperty, I18n.TOOLTIP,
		...
		interString = i18n.get(LayersPanel.class, BufferedBoundaryProperty, I18n.TOOLTIP,
		...
		interString = i18n.get(LayersPanel.class, ShowStatusProperty, I18n.TOOLTIP,
