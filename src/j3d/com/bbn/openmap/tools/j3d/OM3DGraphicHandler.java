...
public interface OM3DGraphicHandler {
    ...
    /**
     * Provide a MapContent object for the
     * OM3DGraphicHandler to add objects to. The MapContent
     * object as three add() methods, one for OMGraphics,
     * one for OMGrid specifically, and one for Shape3D
     * objects. The OM3DGraphicHandler should go through its
     * graphics and add them to this MapContext object. This
     * should be done *before* the OM3DGraphicHandler
