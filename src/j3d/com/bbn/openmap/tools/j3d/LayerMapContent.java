 ...
 * OMGraphicHandlerLayers. The Layer objects are not given
 * height. Although you can control that with the LayerSeparation
 * variable.  This LayerMapContent will also create a simple plane
 * colored the background color of the map.
 *
 * @author    dietrick
...
public class LayerMapContent extends OrderedGroup {
    ...
    /**
     * The default amount of separation to place between
     * layer objects (.1), just to keep them from merging together.
     */
    public final static double DEFAULT_LAYER_SEPARATION = .1;

    /**
     * The height spacer that is being placed between
     * layers, in straight 3D coordinate space.
     */
    protected double layerSeparation = DEFAULT_LAYER_SEPARATION;


    /**
     * Constructor that creates a Group from the
     * OMGraphicHandler layers that are part of the map.
     *
    ...
    /**
     * Constructor that creates a Group from a single
     * OMGraphicHandler layer.
     *
    ...
    /**
     * Add content to this Group. The OMGraphicHandler
     * layers that are part of the map with have their
     * graphics may be added with a small separation between
     * the layers, depending on the value of
     * layerSeparation.
     *
    ...
    /**
     * Add the projection background color to the base level
     * of the Java 3D map. The MapHandler provides the
     * MapBean and therefore the projection.
     *
     * @param bg  The feature to be added to the Sea
     *      attribute
     * @param mh  The feature to be added to the Sea
     *      attribute
     */
...
//              OMGraphic.createBoxShape(0, 0, width, height);
     ...
     *
     * @param bg     The feature to be added to the Content
     *      attribute
     * @param layer  The feature to be added to the Content
     *      attribute
     */
     ...
     *
     * @param bg              The feature to be added to the
     *      Content attribute
     * @param layer           The feature to be added to the
     *      Content attribute
     * @param baselineHeight  The feature to be added to the
     *      Content attribute
     */
    protected void addContent(Group bg, OMGraphicHandlerLayer layer,
            double baselineHeight) {
        Debug.message("3d", "LayerMapContent: putting layer " +
                layer.getName() + " graphics on the map.");
        addTo(bg, OMGraphicUtil.createShape3D(layer.getList(), baselineHeight));
    }


    /**
     * Set the height spacer that is bing placed between
     * layers.
     *
    ...
    /**
     * Return the height spacer that is being placed between
     * layers.
     *
    ...
    /**
     * Add the Shape3D objects from an iterator to a Group
     * object.
     *
     * @param bg             The feature to be added to the
     *      To attribute
     * @param shapeIterator  The feature to be added to the
     *      To attribute
     */
