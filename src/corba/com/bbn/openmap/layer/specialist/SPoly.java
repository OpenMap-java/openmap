 ...
 * or polyline (multi-sided object or line).<p>
 *
 * <h4>ASSUMPTIONS</h4>
 *
 ...
 * define: circles, ellipses, rects, lines.<p>
 */
public class SPoly extends SGraphic /*used to be _PolyImplBase*/ {
    ...
    /** Specifies how the xy points relate to each other on the
        screen. - CModeOrigin (the xy points relate to the first
        point), and CModePrevious (the xy point relates to the
        previous point).*/
