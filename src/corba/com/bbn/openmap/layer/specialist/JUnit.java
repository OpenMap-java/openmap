...
// **********************************************************************
// 
// $Source: /cvs/distapps/openmap/src/corba/com/bbn/openmap/layer/specialist/JUnit.java,v $
...
public class JUnit extends OMGraphic implements ImageObserver, JObjectHolder{
    ...
    public void render(Graphics g) {
        ...
        if (!eunit.bottom1.equals("")) {
            ...
            int y = point1.y + symbol_.getIconHeight() + echelon_.getIconHeight();
    ...
    /** distance() - returns the shortest distance from the unit to
        an XY-point */
    public float distance(int x, int y) {
        ...
        if (point1 == null) {
            System.err.println("JUnit.distance(): invalid" + 
                               " Raster location");
            return distance;
        }
            ...
            (y >= point1.y && y <= point1.y + total_height))
        {
            ...
            distance = Math.max(Math.max(point1.x - x, x - (point1.x + total_width)),
                                Math.max(point1.y - y, y - (point1.y + total_height)));
        }
        return distance;
    ...
    public void update(
        ...
        default:
            System.err.println(
                "JUnit.update: invalid unit symbol update");
