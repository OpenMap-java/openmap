...
public class SText extends SGraphic /* used to be _TextImplBase*/ {
   ...
   *     what is being done here - we're taking the Font structure,
   *     and then going to XFont type text structure.  Dashes need to
   *     be included, line feeds are not.  They are here only for
   *     readability.  The JText object brings this back to a java
   *     Font.  Like wise, doing the transformation this way makes all
