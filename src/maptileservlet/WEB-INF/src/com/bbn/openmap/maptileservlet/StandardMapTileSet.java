 ...
 * location of the data directory or jar, and how to handle empty tiles.
 * 
 * @author dietrick
 */
   ...
   public byte[] getImageData(String pathInfo)
      ...
      try {
         ...
         if (emptyTileHandler != null) {
            TileInfo ti = new TileInfo(filePath);// FPBT: used to be pathInfo
            ti.setMtcTransform(getMtcTransform());
            BufferedImage bufferedImage = ti.getBufferedImage(emptyTileHandler);
            // TODO: Need to incorporate formatter to create the correct image
            // formatter.
