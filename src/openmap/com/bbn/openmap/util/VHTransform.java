...
public class VHTransform {
    ...
    public double getV()   { return this.resultV; }
    /** Return the H corresponding to the most recent toVH(). **/
    public double getH()   { return this.resultH; }
    /** Return the latitude corresponding to the most recent toLatLon(). **/
    public double getLat() { return this.resultLat; }
    ...
    /*
       ...
       Date:         1996/08/28
       Message-ID:   <telecom16.450.6@massis.lcs.mit.edu>
       Newsgroups:   comp.dcom.telecom
       [More Headers]
       [Subscribe to comp.dcom.telecom]
    ...
    */
     ...
     * Ashok Ingle of Bellcore also wrote an internal memo on the subject.<P>
     *
     * The projection is specially modified for the ellipsoid and
     * is confined to the United States and southern Canada.<P>
     *
     ...
     * Tom Libert (tom@comsol.com, libert@citi.umich.edu).<P>
     *
    ...
    /*
       ...
       Date:         1997/03/05
       Message-ID:   <telecom17.57.10@massis.lcs.mit.edu>
       Newsgroups:   comp.dcom.telecom
       [More Headers]
       [Subscribe to comp.dcom.telecom]
    ...
    */
     ...
     *      Co., Utah).  They are just 0.4 radians apart.<P>
     *
     ...
     *                      twice distance between E and W;<BR>
     *              v = square root of absolute value of (square of
     *                      distance to E - square of h).<P>
     *      Reduce by three-tenths of a percent, rotate by 76.597497
     *      degrees, and add 6363.235 to V and 2250.7 to H.<P>
     *
     ...
     *      satisfies the quadratic Azz+Bz+c=0, where<P>
     *              A = (ExWz-EzWx)^2 + (EyWzx-EzWy)^2 + (ExWy-EyWx)^2;<BR>
     *              B = -2[(Ex cos(arc to W) - Wx cos(arc to E))(ExWz-EzWx) -
     *                      (Ey cos(arc to W) -Wy cos(arc to E))(EyWz-EzWy)];<BR>
     ...
     *      arc sine of Pz.  Px and Py satisfy<P>
     *              ExPx + EyPy + EzPz = cos(arc to E);<BR>
     *              WxPx + WyPy + WzPz = cos(arc to W).<P>
