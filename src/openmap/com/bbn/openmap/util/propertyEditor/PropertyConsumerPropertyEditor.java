 ...
 * being defined and/or adjusted.  Any other properties defined need
 * to also be defined at this level, with the property prefix used as
 * a base.  The getProperties() method will be called by the Inspector
 * as a way for this property editor to provide more properties as a
 * result of configuration.
 */
public abstract class PropertyConsumerPropertyEditor extends PropertyEditorSupport 
