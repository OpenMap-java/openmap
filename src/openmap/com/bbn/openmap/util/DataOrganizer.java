...
/**  
 * The DataOrganizer lets you organize objects in a way that will
 * let you retrieve them based on a geographic query.  It's an
 * interface that lets you decide, with an implementation, the best way
 * to manage and retrieve your data.
 */
