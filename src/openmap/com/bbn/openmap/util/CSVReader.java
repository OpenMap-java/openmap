...
/**
 * An object to read Comma Seperated Value file completely. Once read
 * users can ask for tokens using line number and column number.
 */
public class CSVReader {
    // Every element of this vector will contain a vector, which in
    // turn will contain comma delimited values of a line
    ...
    /**
     * Read the Comma seperated file fully and initialize internal
     * data structures.
     */    
