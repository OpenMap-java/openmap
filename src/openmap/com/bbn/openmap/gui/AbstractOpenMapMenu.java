 ...
 */
abstract public class AbstractOpenMapMenu
      extends JMenu
      implements BeanContextChild, BeanContextMembershipListener, PropertyConsumer, MenuBarMenu, LightMapHandlerChild {
   ...
   /**
    * Method called when an object is removed from the MapHandler. Called to let
    * menu objects disconnect from it.
    */
   ...
   public void setProperties(String prefix, java.util.Properties props) {
      ...
      if (!menuItems.isEmpty()) {
         ...
         if (Debug.debugging("menu")) {
            Debug.output("Menu " + getText() + " created with " + nMenuItems + " item" + (nMenuItems == 1 ? "" : "s")
                  + " in properties");
         }
