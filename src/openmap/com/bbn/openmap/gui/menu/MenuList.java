...
public class MenuList extends OMComponent {
    ...
    /**
     * Get a MenuBar with JMenus on it.  If the MenuList has been
     * given a MapHandler, the Menus will have been added to it, and
     * therefore will be connected to OpenMap components.  The MenuBar
     * is not added to the MapHandler and probably shouldn't be,
     * since it will find and re-add the Menus it finds there in some
     * random order.
     */
