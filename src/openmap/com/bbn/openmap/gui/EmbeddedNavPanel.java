...
public class EmbeddedNavPanel extends OMComponentPanel implements
    ...
    protected DrawingAttributes fadeAttributes = new DrawingAttributes();
    protected DrawingAttributes liveAttributes = new DrawingAttributes();
    ...
    public EmbeddedNavPanel(Color buttonColor) {
        this();
        liveAttributes.setFillPaint(buttonColor);
        liveAttributes.setMattingPaint(buttonColor);
    }
...
//        liveAttributes.getPropertyInfo(props);
    ...
    public void layoutPanel() {
        ...
        removeAll();
        int projStackButtonSize = 30;
        int rosetteButtonSize = 20;
        int zoomButtonSize = 16;
        ...
        forwardProjectionButton.setActionCommand(ProjectionStack.ForwardProjCmd);
        ...
        c2.gridx = 0;
        c2.gridy = 0;
        rosette.add(makeButton(OpenMapAppPartCollection.OPP_CORNER_TRI.getIconPart(),
                liveAttributes,
                rosetteButtonSize,
                0.0,
                "Pan Northwest",
    ...
    protected JButton makeButton(IconPart iconPart, DrawingAttributes da,
                                 int size, double ddRot, String tooltip,
                                 ActionListener ac) {
        iconPart.setRenderingAttributes(da);
        return makeButton(OMIconFactory.getIcon(size,
                size,
                iconPart,
                null,
    ...
    protected JComponent makeScaleSlider(DrawingAttributes da) {
        ...
        slider.setBorder(BorderFactory.createLineBorder((Color) da.getFillPaint(),
                1));
