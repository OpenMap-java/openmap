 ...
 */
public class CoordDialog extends JDialog implements Serializable,
    ...
    public CoordDialog() {
        super();
        setTitle(i18n.get(CoordDialog.class,
                "defaultTitle",
                "Go To Coordinates"));
        setup();
    }
    ...
    /**
     * Creates a Dialog Box with a CombinedCoordPanel with a specified
     * title and comment.
     */
    ...
    /**
     * LightMapHandlerChild method. The CoordDialog passes all objects
     * to the CombinedCoordPanel.
     */
