...
public class ImageServer
   ...
   /**
    * Set the layers used on the NEXT request that is processed. Will not affect
    * any image currently being created.
    * 
    * @param newLayers an array of com.bbn.openmap.Layer objects, already
    *        configured and ready to respond to a projectionChanged method call.
    */
    ...
    * approach avoids some of the timing issues that the thread model of the
    * MapBean and Layers that seem to pop up from time to time. They are Swing
    * components, you know. They were designed to be part of a GUI. So, this is
    * a serialized, safe way to do things.
    * 
    ...
    * MapBean and Layers that seem to pop up from time to time. They are Swing
    * components, you know. They were designed to be part of a GUI. So, this is
    * a serialized, safe way to do things. The background used for the image is
    * the one set in this ImageServer object.
    * 
    * @param proj projection of map.
    * @param scaledWidth scaled pixel width of final image. If you don't want it
    *        scaled, use -1.
    ...
    * MapBean and Layers that seem to pop up from time to time. They are Swing
    * components, you know. They were designed to be part of a GUI. So, this is
    * a serialized, safe way to do things. Uses the default background set in
    * the ImageServer.
    * 
    * @param proj projection of map.
    * @param scaledWidth scaled pixel width of final image. If you don't want it
    ...
    * @param scaledHeight scaled pixel height of final image. If you don't want
    *        it scaled, use -1.
    * @param includedLayerMask a mask signifying which of the ImageServer layers
    *        to use in the image. It's assumed that the called knows which
    *        layers are desired. Bit 1 of the mask refers to layer[0], etc. A
    *        bit turned on means the layer will be included.
    * @return a byte[] representing the formatted image.
    */
   ...
   /**
    * Set the layers and image type in the properties. The properties might have
    * a prefix in the file.
    */
   ...
   /**
    * Determine the background color based on property settings. If the property
    * key isn't found, the openmap.BackgroundColor property will be used. If
    * that isn't found, then Color.white will be returned as default.
    * 
   ...
   /**
    * Get the Hashtable used to hold the ImageFormatters. The label for each one
    * is the lookup for it in the Hashtable.
    * 
    ...
    * the hashtable if it's there under the same property name. The Hashtable is
    * kept for an ImageServer that is used buy an ImageMaster or another object
    * that is using different layers for it's image. It will reuse the layers
    * it's already created if the marker names are the same.
    * 
    * @param p properties
    ...
    *        use on the map image. Standard openmap.properties formats for layer
    *        definitions. See the standard openmap.properties file for more
    *        details on how to define layers and plugins.
    * 
    ...
    * 
    * @return the final path of the written image file, with the chosen appendix
    *         attached.
    */
