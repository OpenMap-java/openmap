...
/**
 * The TileMaker is an ImageServer extension that knows how to create image tile
 * sets, like the kind of tiles used by Google Maps and OpenStreetMap. It uses
 * ZoomLayerInfo objects to define how tiles are created for different zoom
 ...
 * @author dietrick
 */
public class TileMaker extends ImageServer {
     ...
     */
    public TileMaker(Properties props) {
        super(props);
    }
     ...
     */
    public TileMaker(String prefix, Properties props) {
     ...
     */
    public TileMaker(Layer[] layers, ImageFormatter formatter) {
    ...
    public void setProperties(String prefix, Properties props) {
        ...
        List<ZoomLevelInfo> zoomLevels = (List<ZoomLevelInfo>) PropUtils.objectsFromProperties(props,
                prefix + ZOOM_LEVELS_PROPERTY,
    ...
    public Properties getPropertyInfo(Properties props) {
        ...
        PropUtils.setI18NPropertyInfo(Environment.getI18n(),
                props,
                com.bbn.openmap.image.TileMaker.class,
    ...
    public byte[] makeTile(double uvx, double uvy, ZoomLevelInfo zoomInfo,
                           Proj proj) {
        Point2D center = TileMaker.tileUVToLatLon(new Point2D.Double(uvx + .5, uvy + .5),
    ...
    public String makeTileFile(double uvx, double uvy, ZoomLevelInfo zoomInfo,
                               Proj proj) throws IOException {
        byte[] imageBytes = makeTile(uvx, uvy, zoomInfo, proj);

        String filePath = zoomInfo.formatImageFilePath(getRootDir(),
                (int) uvx,
                (int) uvy);
                ...
                for (int xoff = 0; xoff < xofflimit; xoff++) {
                    ...
                    for (int yoff = 0; yoff < yofflimit; yoff++) {
                        ...
                        if (parentDirPath == null) {
                            parentDirPath = zfi.formatParentDirectoryName(getRootDir(),
                                    x,
                                    y);
    ...
    public static void main(String[] args) {
        ...
        com.bbn.openmap.util.ArgParser ap = new com.bbn.openmap.util.ArgParser("TileMaker");
        ...
        if (arg != null) {
            ...
            try {
                ...
                TileMaker tim = new TileMaker(props);
                tim.makeTiles();
        ...
        if (arg != null) {
            ...
            if (props == null) {
                ...
                tim = new TileMaker(new Layer[] { shapeLayer }, new SunJPEGFormatter());
                tim.createDefaultZoomLevels(4);

            } else {
                tim = new TileMaker(props);
            }
