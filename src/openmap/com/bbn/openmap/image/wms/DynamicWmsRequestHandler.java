/*
 * $Header: /cvs/distapps/openmap/src/openmap/com/bbn/openmap/image/wms/DynamicWmsRequestHandler.java,v 1.1 2007/01/26 15:04:23 dietrick Exp $
 *
...
public class DynamicWmsRequestHandler extends WmsRequestHandler {
    ...
    public DynamicWmsRequestHandler(int port, String path, Properties props,
            LayerHandler mapLayerHandler) throws IOException, WMSException {
        super(port, path, props);
