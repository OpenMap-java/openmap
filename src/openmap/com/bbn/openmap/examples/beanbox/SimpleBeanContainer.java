...
/** A SimpleBeanContainer is itself a bean. Hence this class extends
  ...
  */
public class SimpleBeanContainer extends SimpleBeanObject 
  ...
  public SimpleBeanContainer (long id, float centerLatitude, float centerLongitude, 
                              float bearingInDeg, 
                              float widthInNM, float heightInNM, 
    ...
    super.setCustomGraphicClassName( 
      "com.bbn.openmap.examples.beanbox.ContainerGraphic");
  ...
  public float getBottomLatitude () {
    return (float)
      (getLatitude() - ProjMath.radToDeg(Length.NM.toRadians(heightInNM / 2)));
  }

  public float getRightLongitude () {
    return (float)
      (getLongitude() + ProjMath.radToDeg(Length.NM.toRadians(widthInNM / 2)));
  }
  ...
  public String toString() {
    return "[SBC " + id + " " + latitude + " " + longitude + 
           ...
           " " + graphicImage + " " + widthInNM + 
           " " + heightInNM + " " + contents + " " + layoutClass + "]";
  }
