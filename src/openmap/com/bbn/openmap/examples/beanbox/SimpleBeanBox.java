 ...
 * SimpleBeanBox manages beans of type SimpleBeanObject.
 */
public class SimpleBeanBox extends BeanBox implements MapMouseListener {
    ...
    /** adds the specified bean to SimpleBeanLayer. This method is called by 
     * the <code>com.bbn.openmap.tools.beanbox.BeanBoxDnDCatcher</code> class
     * to add the specified bean to a openmap layer.
     ...
     * the <code>com.bbn.openmap.tools.beanbox.BeanBoxDnDCatcher</code> class
     * to remove the specified bean from a openmap layer.
     * @throws an IllegalArgumentException
     * if bean is not of type SimpleBeanObject */
     ...
     * in the BeanInfo. Also sets the bean's location.
     * This method is called by 
     * the <code>com.bbn.openmap.tools.beanbox.BeanBoxDnDCatcher</code> class
     * to set the bean's properties before it is displayed in a property sheet
     * prior to adding to an openmap layer.
     * @throws an IllegalArgumentException
     * if bean is not of type SimpleBeanObject */ 
    ...
    /** 
     * returns a SimpleBeanContainer bean that contains the 
     * specified <code>LatLonPoint</code> on the map.
     */ 
    ...
    /** 
     * helper method returns true if the specified <code>LatLonPoint</code>
     ...
     * container encloses the specified point the first one found is returned.
     ...
     * <code>com.bbn.openmap.tools.beanbox.BeanContainer</code> and which 
     * lies closest to and within 10 pixels of the specified (x,y) point. 
     ...
     * beans over container beans. If neither type of bean is found 
     ...
     * <code>com.bbn.openmap.tools.beanbox.GenericPropertySheet</code> when
