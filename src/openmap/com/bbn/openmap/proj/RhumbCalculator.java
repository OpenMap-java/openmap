...
/**
 *
 * @version $Header: /cvs/distapps/openmap/src/openmap/com/bbn/openmap/proj/RhumbCalculator.java,v 1.1 2004/05/10 20:53:58 dietrick Exp $
 * @author pawkub
 *
 * Klasa zawiera metody pozwalaj¹ce przeprowadzaæ obliczenia zwi¹zane z
 * tzw. Rhumblinem. Klasa zawiera kilka ogólnych wzorów i poza OpenMap¹ nie jest 
 * z niczym zwi¹zana.
 * Mo¿na j¹ wrzuciæ do OpenMapy i u¿yæ zawartych w niej wzorów tam gdzie to bêdzie potrzebne
 * (a jest takich miejsc kilka).
 * @todo T¹ klasê nale¿y potraktowaæ jako narzêdzie i wrzuciæ do OpenMapy.
 */
public class RhumbCalculator {
    ...
    /* Metoda pozwala pbliczyæ po³o¿enie punktu na Rhumb Line, znaj¹c po³o¿enie punktu odniesienia,
     * azymut i odleg³oœæ.
     * @param point Punkt odniesienia
     * @param azimuth azymut w stopniach
     * @oparam dist odleg³oœæ w metrach
