...
public abstract class GeoProj extends Proj {
	...
	public Point2D getCenter() {
		return new Point2D.Double(Math.toDegrees(centerX), Math
				.toDegrees(centerY));
	}
	 ...
	 * @see Projection#forwardPoly(float[], int, int, boolean)
	 */
	protected ArrayList forwardRhumbPoly(double[] rawllpts, int nsegs,
			boolean isFilled) {
	 ...
	 * @see Projection#forwardPoly(float[], int, int, boolean)
	 */
	protected ArrayList forwardGreatPoly(double[] rawllpts, int nsegs,
			boolean isFilled) {
		int i, j, k, totalpts = 0;
	 ...
	 * @see Projection#forwardPoly
	 */
	protected ArrayList doPolyDispatch(double[] rawllpts, int ltype, int nsegs,
			boolean isFilled) {
		switch (ltype) {
		case LineType.Rhumb:
			return forwardRhumbPoly(rawllpts, nsegs, isFilled);
	...
	public float getScale(Point2D ll1, Point2D ll2, Point2D point1,
		...
		if (ll1 instanceof LatLonPoint && ll2 instanceof LatLonPoint) {
			return getScale((LatLonPoint) ll1, (LatLonPoint) ll2, point1,
					point2);
		}
	 ...
	 */
	public ArrayList forwardArc(LatLonPoint c, boolean radians, double radius,
	 ...
	 */
	public ArrayList forwardArc(LatLonPoint c, boolean radians, double radius,
			int nverts, double start, double extent, int arcType) {
	 ...
	 *            radius in radians or decimal degrees
	 */
	public ArrayList forwardCircle(LatLonPoint c, boolean radians, double radius) {
	 ...
	 * @see LineType#GreatCircle
	 */
	public ArrayList forwardPoly(double[] rawllpts, int ltype, int nsegs,
			boolean isFilled) {
		ArrayList stuff = _forwardPoly(rawllpts, ltype, nsegs, isFilled);
		// @HACK: workaround XWindows bug. simple clip to a boundary.
		// this is ugly.
	...
	// }
	//
	// public boolean forwardRaw(float[] rawllpts, int rawoff, int[]
	// xcoords,
	...
	// }
	//
	// public boolean forwardRaw(double[] rawllpts, int rawoff, int[]
	// xcoords,
	// int[] ycoords, boolean[] visible, int copyoff,
	// int copylen) {
	// // TODO Auto-generated method stub
	...
	// }
	//
	// protected ArrayList _forwardPoly(float[] rawllpts, int ltype,
	// int nsegs,
	// boolean isFilled) {
	// // TODO Auto-generated method stub
	// return null;
	// }
	//
	// protected ArrayList _forwardPoly(double[] rawllpts, int ltype,
	// int nsegs,
	// boolean isFilled) {
	// // TODO Auto-generated method stub
	// return null;
