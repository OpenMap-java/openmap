 ...
 * a properties file.  You can add ProjectionLoaders to the
 * MapHandler, and if the ProjectionFactory singleton instance has
 * been added to it as well, it will be picked up and the projection
 * made available to the application.  For example, the
 * BasicProjectionFactory allows you to set thse properties for the
 * Mercator projection:<pre>
 *
 ...
 *
 * </pre> The prettyName and description properties should have
 * defaults, but internationalized strings can be substituted as needed.
 */
public abstract class BasicProjectionLoader extends OMComponent 
     ...
     */
    public abstract Projection create(Properties props) throws ProjectionException;
    ...
    public void setProperties(String prefix, Properties props) {
        ...
        description = props.getProperty(prefix + DescriptionProperty, description);
    }
