...
public class MGRSPoint
    ...
    protected void decode(String mgrsString)
        ...
        if (DEBUG) {
            logger.fine("Decoded " + mgrsString + " as zone number: " + zone_number + ", zone letter: " + zone_letter
                    + ", easting: " + easting + ", northing: " + northing + ", 100k: " + hunK);
        }
    }
    ...
    public void resolve() {
        if (zone_letter == 'Z') {
            ...
            StringBuffer sb =
                    new StringBuffer(Integer.toString(zone_number)).append(zone_letter).append(get100kID(easting, northing,
                                                                                                         zone_number));
            ...
            if (DEBUG) {
                logger.fine(" Resolving MGRS from easting: " + seasting + " derived from " + easting + ", and northing: "
        ...
        try {
            ...
            while ((record = lnr.readLine()) != null) {
                if (inType.equalsIgnoreCase("MGRS")) {
                    ...
                    outStr1.append(record).append(" to UTM: ").append(mgrsp.zone_number).append(" ").append(mgrsp.easting)
                           .append(" ").append(mgrsp.northing).append("\n");
