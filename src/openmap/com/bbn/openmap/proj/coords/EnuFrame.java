 ...
 * <p>
 * I like the idea of hiding the detail of the transformation from the user.
 * The user needs no detailed knowledge of mathematics and
 * if we change the algorithm, nobody will be affected.
 * <p>
 * Author: Robert Hayes
 */
public class EnuFrame {
    ...
    public static void main(String[] args) {
        ...
        double ecefVector[] = new double[3];
        double enuVector[] = new double[3];
        double longitude = Math.toRadians(40.00);
        double latitude = Math.toRadians(-74.50)
        ...
        //System.err.println("" + ecefVector[0] + ":" + ecefVector[2]+ ecefVector[2] );
        //System.err.println("" + enuVector[0] + ":" + enuVector[2]+ enuVector[2] ); 
    

        // TEST1  
        test.ecef2enu(ecefVector, latitude, longitude, enuVector);
        System.err.println("TEST1:");
        System.err.println("ECEF:" + ecefVector[0] + " : " + ecefVector[1]+ " :" +ecefVector[2] );
        System.err.println("ENU:" + enuVector[0] + " : " + enuVector[1]+ " : "+enuVector[2] );
        ...
        // TEST2
        test.enu2ecef(ecefVector, latitude, longitude, enuVector);
