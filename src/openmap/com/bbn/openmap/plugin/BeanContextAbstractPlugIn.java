...
/**
 * This class is an abstract implementation of the PlugIn. It does all
 * the things the AbstractPlugIn does, but also carries the support
 * baggage for PlugIns that want to play in the BeanContext.
 * 
