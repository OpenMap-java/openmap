 ...
 * The I18n implmentation will define where the resources for the given
 * class are stored.
 * <P>
 * <B>Intended Usage:</B> <P>
 ...
 * internationalized version of a given string.  This would look like the
 * following:<P>
 * <code>
 * I18n i18n = Environment.getI18n();<br>
 * String message = i18n.get(this, "message", "Please enter a number: ");<br>
 * </code><P>
 * There is also similar version of <code>get(...)</code> that takes a
 * <code>Class</code> instead, and thefore can be used in static contexts. 
 * If the Strings you are looking for pertain to specific types (i.e. uses)
 * you can you the form of <code>get(...)</code> that specifies this, as the
 ...
 * <code>Class</code> instead of an object so it can be used in static 
 * contexts.
 * <P>
 * Note that in both examples given, the <code>field</code> parameter to the 
 * <code>get(...)</code> methods are the name of the variable that holds the 
 ...
 * <P>
 * Note also that there are several additional <code>get(...)</code> methods
 * that can be used to make getting paramaterized 
 * (as if by <code>MessageFormat</code>) Strings easier.
 * 
 * <LI><I><B>Swing Usage:</B></I><BR>
 * If you are setting the text fields on Swing objects, the 
 * <code>set(...)</code> methods of this class can help you.  Here is an
 * example:<P>
 * <code>
 * I18n i18n = Environment.getI18n();<br>
 ...
 * <code>set(...)</code> method is the name of the field that holds the object
 ...
 * For the typical uses of this class, there are two calls that can make things
 * very easy, by doing a bunch of the work for you.  In most implementations
 * if this interface, they will accomplish this via reflection under-the-hood.
 ...
 * <code>myButton</code> variable, without the programmer having to do 
 * much at all.  Here is an example of the other reflective method:<P>
 * <code>
 * public class MyClass {<BR>
 * &nbsp;&nbsp;JButton myButton = new JButton();<BR>
 ...
 * all of the relevant objects, in this case both <code>myButton</code> and
 * <code>myLabel</code>.
 * </UL> 
 * <P> 
 * <SMALL>In case you were wondering, the oft used I18n
 * abreviation comes from the 18 characters between the 'I' and the 'n' in
 * the word Internationalization.</SMALL>
...
public interface I18n {
     ...
     * ResourceBundle.
     * <P>
     * <B>Note: This method just looks for a TitledBorder on the component.</B>
     * @param requestor object containing the code requesting the String
     * (typically <code>this</code).
     * @param field the field the String belongs to.  Typically this will
     * be the variable name refering to the <code>comp</code> parameter.
     ...
     * setup (typically <code>this</code).
    ...
    /**
     * Fill in all of the fields of the given object that are of known types
     * (see the set(...) methods of this class) with values obtained from
