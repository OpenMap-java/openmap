...
public class Intersection {
     ...
     */
    public static float pointCircleDistance(float lat1, float lon1, float lat2,
     ...
     */
    public static boolean intersectsCircle(float lat1, float lon1, float lat2,
                                           float lon2, float lat, float lon,
                                           float radius) {
        ...
        float dist = pointCircleDistance(lat1, lon1, lat2, lon2, lat, lon);
        ...
        // between seg1 endpoints and second point of intersection
        double d21 = Geo.distance(lat1,
                lon1,
                i2.getLatitude(),
                i2.getLongitude());
        double d22 = Geo.distance(lat2,
                lon2,
                i2.getLatitude(),
                i2.getLongitude());
    ...
    public static boolean intersectsCircle(float[] polyPoints, float lat,
        ...
        for (int i = 0; i < polyPoints.length / 2 - 1; i++) {
            ...
            if (intersectsCircle(lat1, lon1, lat2, lon2, lat, lon, radius))
                return true;
        }
     ...
     */
    public static float greatCircleDistance(float lat1, float lon1, float lat2,
                                            float lon2) {
    ...
    public static void main(String[] args) {
        ...
        float[] polypoints1 = new float[] { 60, -130, 60, -70, 30, -70, 30,
                -130, 60, -130 };

        float[] polypoints2 = new float[] { 50, -60, 50, -40, 20, -40, 50, -60 };
        ...
        boolean b3 = intersectsCircle(60,
                -130,
                70,
                -100,
                60,
