...
/**
 * This is a Ken Anderson class for dealing with geographical
 * coordinates.
 * <p>
...
public class Geo {
    ...
    public double azimuth(Geo v2) {
        /*
         * n1 is the great circle representing the meridian of v1. n2
         * is the great circle between v1 and v2. The azimuth is the
         * angle between them but we specialized the cross product.
         */
