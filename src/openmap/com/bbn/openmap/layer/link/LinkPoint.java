 ...
 * value indicating the size associated with this point.  OMPoints
 * also support whether the point should be rendered as a rectangle or
 * an oval.  That choice is specified as a property for the LinkPoint,
...
public class LinkPoint implements LinkGraphicConstants, LinkPropertiesConstants {
    ...
    /**
     * The property for the LinkPoint to specify if the OMPoint
     * should be rendered as an oval. The value should be true or
     * false, depending if the point should be rendered as an oval.
     */
     ...
     * (RENDERTYPE_OFFSET).
     * It doesn't matter which corners of the point are used, as
