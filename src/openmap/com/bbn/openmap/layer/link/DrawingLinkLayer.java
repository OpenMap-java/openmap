 ...
 * </pre>
 */
public class DrawingLinkLayer extends LinkLayer {
     ...
     */
    public DrawingLinkLayer(String host, int port, String propertiesURL) {
    ...
    public boolean mouseClicked(MouseEvent e) {
        ...
        try {
            ...
            // Don't need these anymore, look below for explanation
