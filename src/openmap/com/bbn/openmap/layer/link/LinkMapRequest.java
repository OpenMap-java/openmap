...
/**  
 * A LinkMapRequest presents a view onto a map.  This view can
 * be used to create a list of graphics that should be added to the
 * map, or to query a spatial database engine for other graphics. <P>
 *
...
public class LinkMapRequest {
     ...
     * cross the dateline.  For areas like that that need to be
     * described,, several LinkBoundingPolys must be used. */
    ...
    /**  
     * The constructor to use when reading the LinkMapRequest off
     * the link.
     ...
     * bounding polygon is a series of floats, alternating latitude
