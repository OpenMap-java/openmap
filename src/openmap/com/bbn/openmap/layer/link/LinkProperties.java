 ...
 * going to be sent over the link. In java-land, they are handled with
 * the Properties object. In link-land, they are handled like an array
 * of strings. Requests have a properties section, and graphic objects
 * have them as well.
 */
public class LinkProperties extends Properties implements
     ...
     * DrawingAttributes properties on an OMGraphic. Will set the line
     * and select colors, fill paints (including patterns) and stroke
     * based on the properties contained in this LinkProperties
    ...
    public Paint getPaint(String paintProperty, String defaultPaintString) {
        return ColorFactory.parseColorFromProperties(this,
                paintProperty,
                defaultPaintString,
                true);
    }
