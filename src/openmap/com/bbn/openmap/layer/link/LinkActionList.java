...
public class LinkActionList implements LinkActionConstants, LinkPropertiesConstants {
     ...
     * the form of a Vector of LinkActionList.GraphicUpdate
     * objects.
     *
    ...
    /**
     * If a ACTIONS_HEADER has been encountered coming off
     * the link, then this method should be called to read the string
     * of gesture that follows.  The gestures are read and reacted to
     * directly - the responses that involve the Information Delegator
     * are handled here, and all graphic updates are stored in the
     * graphicUpdates Vector.  Assumes the ACTIONS_HEADER has
     * been read.
     *
     * @param layer the layer that wants the gesture results..
     * @param proj If you want the gesture graphic to be projected as it
     * comes off the wire, add a projection here.  Otherwise, use null.
     * @param generator an OMGridGenerator that knows how to render
     * grid objects.
     ...
     * Assumes that the gesture type and graphic action has been read.
     *
     ...
     * circle.  If negative, the client algorithm will figure out what
     * is best.
     * @param properties description of drawing attributes.
     * @param graphicUpdateMask the mask describing the graphic update.
     * @throws IOException
     ...
     * whether the x and y points are relative to the first point, or
