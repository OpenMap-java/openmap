 ...
 *  It is launched within its own thread to handle a specific client.
 *  If the server is accessing a database or an object that many
 *  LinkServers may be contacting, You'll need to ensure some amount
 *  of thread safety for the data if the data is being modified by the
 *  LinkServer. 
 */
