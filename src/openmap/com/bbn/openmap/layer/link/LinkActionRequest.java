...
public class LinkActionRequest implements LinkActionConstants, LinkPropertiesConstants {
    ...
    /** The terminator of the graphics section when receiving gesture queries. */
     ...
     *  background and is not affiliated with a particular
     *  graphic. Otherwise, the graphic ID string is returned for the
     *  affiliated graphic.  
     */
