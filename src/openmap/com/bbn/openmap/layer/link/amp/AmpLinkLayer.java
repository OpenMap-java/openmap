 ...
 * layer also wants access to the DrawingTool.<P>
 *
 ...
 * </pre> 
 */
public class AmpLinkLayer extends LinkLayer 
    implements Tool {
    ...
    /**
     * Just need to check here if one of the new extra graphics
     * (range ring) was clicked on, so that it can be sent to the
