 ...
 * care about.  The state, as defined in your implementation, can
 * reset the StateMachine to it's new state after it responds to an
 * event.<P>
 *
...
public abstract class State 
    implements ActionListener, AdjustmentListener, 
               ...
               ItemListener, KeyListener, MapMouseListener, 
