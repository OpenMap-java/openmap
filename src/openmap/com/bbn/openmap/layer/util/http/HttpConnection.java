...
public class HttpConnection extends Thread {
    ...
    protected void readContent(int length) throws IOException{
        ...
        try {
            while(nread < length) {     
                ...
                Debug.message("httpconnection","Length of content read " + nread);
            }
    ...
    /**
     * Can be used to write the header to an HttpResponse.  You need
     * to create a Writer tied to the OutputStream in order to write
     * this text.
     *
     ...
     */
    public static void writeHttpResponse(OutputStream out, 
                                         String contentType,
                                         String response) 
        throws IOException {
