...
public class SpatialIndex
    ...
    * The spatial index is searched for intersections and the appropriate
    * records are read from the shape file.
    * 
   ...
   public OMGraphicList getOMGraphics(double xmin, double ymin, double xmax, double ymax, OMGraphicList list,
      ...
      if (shp != null) {
         shp.close();
         // Not sure why we want to set this null here. It's cleaner, but a new
   ...
   /**
    * Prints a usage statement describing how to use this class from the command
    * line.
    * 
