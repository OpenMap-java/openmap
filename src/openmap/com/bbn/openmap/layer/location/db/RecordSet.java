 ...
 *<LI>Use getResultSet(), which provides the result set containing the
 *current record data.  This can be done within the constructor of the
 *data object you are trying to create.
 *</UL>
 */
public class RecordSet {
    ...
    /**
     * Does everything.  If the connection and query are not null,
     * then the result set is ready for iteration after this object is
     * created.  
     */
