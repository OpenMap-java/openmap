 ...
 * Data from a table in a Database given a City/Town name, State.
 * Also it retrieves identifier of the object that would be used to
 ...
 * select CITY (string), STATE (string), GRAPHIC (string, url or graphic name), LATITUDE (float), LONGITUDE (float) from LOCATION_TABLE (tablename where data is stored)<BR>
