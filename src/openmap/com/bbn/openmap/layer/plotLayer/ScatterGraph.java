...
public class ScatterGraph {
    ...
    // A Vector of the GLOBESites that are currently displayed on the map.
    ...
    /**
     * Set the max and min points (as well as the scale factors) for the 
     * plot.
     *
     ...
     * This is just (value - offset) * scale
     *
