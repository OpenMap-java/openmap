...
public class GLOBETempData extends GLOBEData {
	...
	Data Format:
      ...
      Field 3  = Site number 
      Field 4  = Time the data was reported, YYYYMMDD where
         YYYY  = Calendar year
           MM  = Calendar month (starting with 1 = January)
           DD  = Day of month  (starting with 1)
      Field 5  = Time the data was sampled, YYYYMMDDHH where
         YYYY  = Calendar year
           MM  = Calendar month (starting with 1 = January)
           DD  = Day of month  (starting with 1)
      ...
      Example: 
      AT 1     1 19961218 1996121814 1996.96334  44.1281  -68.8747    14    18    22    -2
...
/**
 * See if these values for temp and year are outside of our current
 * notion of how large our data space is.
 *<p> 
 * @param temp
 * @param year
 */
