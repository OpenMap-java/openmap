...
// **********************************************************************
// 
// $Source: /cvs/distapps/openmap/src/openmap/com/bbn/openmap/layer/plotLayer/GLOBESite.java,v $
...
//     {return ((Number)max_temp_table_.get(new Float(year))).floatValue();}
...
//     {return ((Number)min_temp_table_.get(new Float(year))).floatValue();}
    ...
    public float getMaxTemp() { return max_temp_; }
    public float getMinTemp() { return min_temp_; }
    public float getMaxYear() { return max_year_; }
    public float getMinYear() { return min_year_; }
