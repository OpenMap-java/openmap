 ...
 * animated layer would be on top of it.
 * <P>
 * 
 ...
 * default), then the layers will get buffered into an image.
 * <P>
 * 
...
public class BufferedLayer extends Layer implements PropertyChangeListener {
     ...
     * needs to be set if the background is at all transparent. If the
     * background of the internal MapBean is opaque, set this to
     ...
     * the BeanContext to call findAndInit() over. Sets BeanContext on
     * sub-layers.
     */
    ...
    /**
     * Add a layer to the group. Sets the BeanContext on the added
     * layer.
     */
     ...
     * gone and replaces with whatever is attached to the new MapBean.
     * 
    ...
    /**
     * Class that helps track turning on/off layers in the buffered
     * layer.
     */
