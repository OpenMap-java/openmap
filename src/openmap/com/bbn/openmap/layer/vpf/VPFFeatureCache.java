...
public class VPFFeatureCache extends CacheHandler {
     ...
     * lists.  The cached list will for the featureType/path code will
     * be added to this list, regardless of whether it's been
     * populated or not.  The requestor list will be returned when the
     * warehouse is asked for the graphics list.
     * @return true if the list has already been loaded and the caller
     * doesn't need to read the data files to create list contents.
     */
     ...
     * If the CoverageTable reads the data files, the OMGraphics
     * created from the files will be added to the list added to the
     * requestor.
