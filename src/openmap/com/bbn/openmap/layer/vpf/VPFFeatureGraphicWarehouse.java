...
public class VPFFeatureGraphicWarehouse
    ...
    *        when appended to the prefix, will serve as a prefix for the drawing
    *        attributes settings for that feature. With a layer prefix of
    *        vmapRoads, and a feature type of roadl, the line color attribute
    *        property looked for will be vmapRoads.roadl.lineColor.
    */
    ...
    * The keys to the Hashtable should be the feature type names, and the values
    * should be the DrawingAttributes for that feature.
    */
