...
public class RpfCoverageBox {
    ...
    * 
    * NOTE:
    * Empirically noticed that # of subframes sometimes 
    * underreported because these cast to an int.  Rounding would sometimes 
    * overreport, however.  Observed that a tolerance of .000001 would define
    * when to round up. This appeared to be causing gaps at zone boundaries,
    * since a coverage box could think it doesn't have a certain subframe,
