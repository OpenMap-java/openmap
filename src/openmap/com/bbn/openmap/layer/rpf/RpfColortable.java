...
public class RpfColortable {
    ...
    public OMColor[] colors = null;
    /** Zone ID for these colors.*/
    public char zone;
    /** Chart Series Code for these colors. */
    public String seriesCode;
    /** The index of the A.TOC file in the RpfTocHandler being used
     *  for the current colors. */
    ...
    /**
     * Not really used, but someone might need them.  Returns the
     * A.TOC index number of the colors, to compare to see if a new
    ...
    /**
     * Not really used, but someone might need them.  Returns the
     * A.TOC entry number of the colors, to compare to see if a new
     * colortable is needed. 
     */
