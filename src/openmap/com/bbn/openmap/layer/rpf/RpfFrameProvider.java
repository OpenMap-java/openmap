...
public interface RpfFrameProvider {
     ...
     * change at the RpfCacheHandler/RpfCacheManager.  If the source
     * of the data is a server, this should return yes.  If the source
     * is local, the view attributes will be a shared object and
     * updates are not nessary.
     */
