...
public class DeclutterMatrix {
    ...
    /** The width of the screen to be covered by the matrix, in
     * pixels. The number of horizontal matrix cell is the
     ...
     *  matrix. */
    protected int maxx;
    /** The maximum index for the vertical locations within the
     *  matrix. */
    protected int maxy;
     ...
     *  for a search.  This is to limit the number of off matrix
     *  indexes used.  */
     ...
     * finding an open space.  The square expands outward until a
     * place is found, or until no place is found, given some desired
     * limit. */
     ...
     * direction is noted as DCD_EW.  Corners have no search
     * direction, and the left and right sides have North-South search
    ...
    /** 
     * Construct a new DeclutterMatrix, given the screen dimensions and the 
...
//                          }
    ...
    /**
     * Check to see if there is space to the left and right.  This
     * just checks for all the way to the right, and all the way to
     * the left.  
    ...
    /** 
     * This is a graphics that is only available to fiddle around
     * with text and fonts, in order to get pre-measurements. DO NOT
     * write anything into this thing.  
