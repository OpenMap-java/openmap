 ...
 * on an Icon.  It has a java.awt.Shape object that specifies what
 * gets rendered, and it has a clipping shape that specifies how much
 * of the shape gets rendered.  The rendering attributes specify how
 * the shape is colored, drawn, etc.
 *
