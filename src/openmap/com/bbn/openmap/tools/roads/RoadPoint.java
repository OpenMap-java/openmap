...
// **********************************************************************
// 
// $Source: /cvs/distapps/openmap/src/openmap/com/bbn/openmap/tools/roads/RoadPoint.java,v $
...
public class RoadPoint extends Waypoint implements RoadObject {
    ...
    public String toString () { return "RoadPoint on road " + road + ", " + super.toString(); }
}
