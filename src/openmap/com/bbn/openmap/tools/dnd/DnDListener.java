 ...
 * Some of its methods should be overriden by extending classes.
 *
...
public class DnDListener extends MouseDragGestureRecognizer implements DragSourceListener, DropTargetListener {
    ...
    // startDrag is a boolean flag. When set to true it enables dragging.
     ...
     * If not found, return the passed cursor.
     */
