...
/**
 * The {@link com.bbn.openmap.tools.beanbox.BeanBox} treats all bean objects that
 * implement this interface as container beans.
 */
public interface BeanContainer {
   ...
   * The layout manager bean is responsible for laying out the contents
   * of this container.
   */
  public void setLayout(BeanLayoutManager layout);

  /**
   * gets the class name of the layout manager 
   * bean assocciated with this container.
   */
  public String getLayoutClass();

  /**
   * sets the class name of the layout manager 
   * bean assocciated with this container.
   */
  public void setLayoutClass(String lc);

  /**
   * calling this method is meant to generate a call to the layout manager's
