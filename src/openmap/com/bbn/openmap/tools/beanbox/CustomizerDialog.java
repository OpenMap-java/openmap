 ...
 * This includes adding the Frame and the "ok" and "cancel" buttons. This class is
 * used by the {@link com.bbn.openmap.tools.beanbox.GenericPropertySheet} to show
 * a bean customizer.
 */
public class CustomizerDialog extends Dialog implements ActionListener {
    ...
    /**
     * Constructor taking the parent frame, the customizer component and the
     * target bean as arguments.
     */
