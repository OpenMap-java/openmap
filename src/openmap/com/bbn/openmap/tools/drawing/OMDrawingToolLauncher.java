...
public class OMDrawingToolLauncher
   ...
   public OMDrawingToolLauncher() {
      ...
      setWindowSupport(new WindowSupport(this, i18n.get(OMDrawingToolLauncher.class, "omdrawingtoollauncher",
   ...
   public void resetGUI() {
      ...
      panel =
            PaletteHelper.createHorizontalPanel(i18n.get(OMDrawingToolLauncher.class, "panelGraphicAttributes",
                                                         "Graphic Attributes:"));
   ...
   public Container getFace() {
      ...
      if (getUseAsTool()) {
         ...
         JButton drawingToolButton =
               new JButton(new ImageIcon(OMDrawingToolLauncher.class.getResource("Drawing.gif"),
                                         i18n.get(OMDrawingToolLauncher.class, "drawingToolButton", I18n.TOOLTIP,
                                                  "Drawing Tool Launcher")));
         drawingToolButton.setToolTipText(i18n.get(OMDrawingToolLauncher.class, "drawingToolButton", I18n.TOOLTIP,
                                                   "Drawing Tool Launcher"));
   ...
   public void setProperties(String prefix, Properties props) {
      ...
      maxHorNumLoaderButtons =
            PropUtils.intFromProperties(props, prefix + HorizontalNumberOfLoaderButtonsProperty, maxHorNumLoaderButtons);
   ...
   public Properties getPropertyInfo(Properties props) {
      ...
      String internString =
            i18n.get(OMDrawingToolLauncher.class, HorizontalNumberOfLoaderButtonsProperty, I18n.TOOLTIP,
      ...
      internString =
            i18n.get(OMDrawingToolLauncher.class, UseLoaderTextProperty, I18n.TOOLTIP, "Use text popup for loader selection.");
