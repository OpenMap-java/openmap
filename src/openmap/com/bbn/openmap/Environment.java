 ...
 * the runtime environment for this process.
 * <p>
 ...
 * exist only while the process is running.  They are calculated
 * during Environment initialization and are not persistent.<p>
 ...
 * file.  They are meant to be used as a last resort.<p>
 * </ul>
...
public class Environment extends Properties {
    ...
    // metanames of the names of the variables used in the OpenMap system
    ...
    public static transient boolean doingXWindowsWorkaround = false;// will do it if isXWindows

    public final static transient String title="$$Title="+MapBean.title;
    public final static transient String version="$$Version="+MapBean.version;
    public final static transient String build="$$BuildDate=";//autobuild should set this.
	...
	} catch (NoSuchElementException e) {}// no BuildDate
    }
...
//  	    Debug.output("Reinitializing Environment!");
     ...
     * Installs the default System Properties into the Environment.
     */
    ...
    /**
     * Populates the system properties for an applet.  Currently
     * this property list contains the ten system properties available
     * to applets and any applet parameters specified in
     ...
     * Runtime properties are those properties that exist only while
     * the program is running.  They are not persistent.  Persistent
     * properties should be stored in the user properties list.
     *
	...
	// the UniqueID is generated from other runtime values.  This should
	// be unique for this Java VM.  Note that for security reasons, you
...
//  	    doingXWindowsWorkaround = true;
     ...
     * @return    the value of the property with the specified key or
     *            <code>defaultValue</code> if there is no property with
     *            that key.
     */
     ...
     * This should be unique compared to other strings generated this
     * way.
     * @return String
    ...
    /**
     * Get the JLayeredPane to use for Internal Frames.  May be null
     * if the Environment hasn't be set with the root pane.
     */
