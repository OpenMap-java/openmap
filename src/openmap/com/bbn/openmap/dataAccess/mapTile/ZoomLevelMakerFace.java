...
public class ZoomLevelMakerFace
   ...
   public ZoomLevelMakerFace(ZoomLevelMaker zfi, MapTileMakerComponent mtmc) {
      ...
      JLabel rangeLabel = new JLabel(i18n.get(ZoomLevelMakerFace.class, "range", "Zoom Level Range"));
      ...
      addIntroEntry(introPanel, intro, zoomHolder, 0);
      addIntroEntry(introPanel, tileDimLabel, tileDimensions, 1);
      addIntroEntry(introPanel, baseScaleLabel, scaleButton, 2);
      ...
      layerPanel.setBorder(BorderFactory.createTitledBorder(layers_for_title));
      setLayers(layerList);
      add(layerPanel, c);
      ...
      // i18n.get(ZoomLevelMakerFace.class,
      // "apply_boundaries_to_all_zoom_levels",
      // "Apply boundaries to all zoom levels");
   ...
   protected void addIntroEntry(JPanel panel, JComponent left, JComponent right, int y) {
      GridBagConstraints c = new GridBagConstraints();
   ...
   protected void setLayers(List<LayerObject> layerObjects) {
      ...
      // i18n.get(ZoomLevelMakerFace.class,
      // "apply_level_settings_to_all_zoom_levels",
      // "Apply level settings to all zoom levels");
