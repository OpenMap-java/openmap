...
public class ColorTable
   ...
   public ColorTable(int ec, int eid, int l, DataInputStream in)
         throws IOException {
      super(ec, eid, l, in);
   ...
   public Color get(int index) {
      index -= startingIndex; // Not sure what starting index means - the number
                              // of colors to get to 0th color or something to
                              // subtract from provided index to get to front of
