...
/**
 * Provides methods for writing data to an output stream in LittleEndian and
 * BigEndian.  Adapted from the book, Java IO, Elliotte Rusty Harold, Ch. 7.
...
//        }
  ...
  /**
   * Constructor
   * out The output stream to chain this one to.
   */
