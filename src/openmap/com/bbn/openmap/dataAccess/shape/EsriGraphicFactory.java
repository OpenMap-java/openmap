...
public class EsriGraphicFactory
   ...
   public OMGraphic makeEsriGraphicFromRecord(int byteOffset, LittleEndianInputStream iStream, DrawingAttributes drawingAttributes,
                                              Object pointRepresentation, ReadByteTracker byteTracker)
         throws IOException, FormatException {
   ...
   protected OMGraphic makeEsriGraphic(BinaryFile shpFile, DrawingAttributes drawingAttributes, Object pointRepresentation,
       ...
       * SHAPE_TYPE_POLYLINE = 3; SHAPE_TYPE_POLYGON = 5; SHAPE_TYPE_MULTIPOINT
       * = 8; SHAPE_TYPE_POINTZ = 11; SHAPE_TYPE_POLYLINEZ = 13;
       * SHAPE_TYPE_POLYGONZ = 15; SHAPE_TYPE_MUILTIPOINTZ = 18;
       * SHAPE_TYPE_POINTM = 21; SHAPE_TYPE_POLYLINEM = 23; SHAPE_TYPE_POLYGONM
       * = 25; SHAPE_TYPE_MULTIPOINTM = 28; SHAPE_TYPE_MULTIPATCH = 31;
       */
      EsriGraphic eg = null;
    ...
    * @param representation The object to use for representing the Point. If the
    *        object is an ImageIcon, that image is used for a scaling icon at
    *        this point. If it's a String, and OMText will be created for that
   ...
   protected EsriGraphic createPolylineZGraphic(BinaryFile shpFile, DrawingAttributes drawingAttributes, ReadByteTracker byteTracker)
         throws IOException, FormatException {
   ...
   protected EsriGraphic createPolylineMGraphic(BinaryFile shpFile, DrawingAttributes drawingAttributes, ReadByteTracker byteTracker)
         throws IOException, FormatException {
   ...
   protected EsriGraphic getPolys(BinaryFile shpFile, int numParts, int numPoints, int shapeType,
      ...
      for (int i = 1; i < numParts; i++) {
         ...
         if (verbose) {
            logger.info("creating " + ShapeUtils.getStringForType(shapeType) + "(" + i + ") with coords[" + getCoordString(coords)
                  + "]");
         }
