...
public class TextShapeDecoration extends AbstractShapeDecoration {
    ...
    /** Text will follow the poly instead of being written on the segment
     * from begin to end of the poly, also allow text to be uncomplete. 
     * You may add this one to the other constants */
    ...
    private void initMetrics() {
        if (g2D == null) 
            g2D = (Graphics2D) new BufferedImage(10, 10, BufferedImage.TYPE_INT_RGB)
                .getGraphics();
        if (font == null)
            font = g2D.getFont();
     ...
     * @see fr.shom.jcirrus.awt.ShapeDecoration#draw(Graphics, Point2D[], boolean)
     */
     ...
     * @param angle
     */
    public static void drawAngledString(
        Graphics g,
        String text,
        int x,
        int y,
