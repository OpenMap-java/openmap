...
public abstract class BasicGeometry
    ...
    * along the land. LINETYPE_RHUMB means a line will be drawn along a constant
    ...
    * This object can contain attribute information about the geometry.
    * 
    * @see #setAppObject
    * @see #getAppObject
    */
    ...
    * and we need to show the other edge of the graphic on the other side of the
    * earth.
    */
   ...
   /**
    * Set the line type for the graphic, which will affect how the lines will be
    * drawn. See the definition of the lineType parameter. Accepts
   ...
   /**
    * Holds an application specific object for later access. This can be used to
    * associate an application object with an OMGeometry for later retrieval.
    * For instance, when the graphic is clicked on, the application gets the
    * OMGeometry object back from the OMGeometryList, and can then get back to
    * the application level object through this pointer.
    * <P>
    * 
   ...
   /**
    * Gets the application's object pointer. If an attribute Map object is being
    * used, returns the object stored in that map under the APP_OBJECT_KEY key.
    * 
    * @return Object
    */
   ...
   /**
    * Removes all of the objects stored in a Map stored in the appObject. If the
    * appObject is a Map, the clear command will be passed to it even if the Map
    * isn't considered to be the 'official' attribute Map.
    */
    ...
    * <code>render()</code>! If a vector graphic has lat-lon components, then we
    ...
    * <P>
    * 
    * This method used to be abstract, but with the conversion of OMGeometrys to
    ...
    *         the graphic needs to be generated with the current map projection,
    ...
    * to clear out the object to save memory, or to allow a little customization
   ...
   public void restore(OMGeometry source) {
      ...
      if (attributes != null) {
         ...
         // But, now the ATT_MAP_KEY points to the source attributes map. Need
         // to adjust...
