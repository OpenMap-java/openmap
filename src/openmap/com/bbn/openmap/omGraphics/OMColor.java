 ...
 * some degree of transparency.  The class lets you set the alpha
 * value of the color which lets the color be invisible (0) to opaque
 * (255).  At this time, the java.awt.Graphics class does not support
 * transparency for drawing objects (OMLines, OMRects, OMCircles, etc.)
 * but the transparent colors work for OMBitmap and OMRaster pixel
 * values.  <p>
 *
 * The OMColor object captures all calls that reference the
 * package-internal <code>java.awt.Color.value</code> slot, and
 * re-route them through the local argb slot. <p>
 *
 * NOTE concerning the OpenMap 4.0 release.  As of 4.0, OpenMap now
 * has a minimum jdk 1.2 requirement, which means that OMColor seems
 * to duplicate java.awt.Color.  We're going to keep this class
 * around, however, in case someone needs a mutable Color.
 *
 * @see com.bbn.openmap.util.ColorFactory 
 */
public class OMColor extends java.awt.Color {

    /**
     * Does this Java version support alpha for java.awt.Colors?.
     * This is true if java.version &gt;= 1.2, and false otherwise.
     */
...
//       * 1.2 java.awt.Color constructor with the same type/number of
//       * arguments.  It should be OMColor(int r, int g, int b, int a).
    ...
    /**
     * Create a color with the specified ARGB (Alpha, Red, Green,
     * and Blue) values.
     * The alpha component is in bits 24-31 of the argument, the red
     * component is in bits 16-23 of the argument, the green component
     * is in bits 8-15 of the argument, and the blue component is in
     * bits 0-7.  
     ...
     * indicates no contribution from the primary color component.
     * The value 1.0 indicates the maximum intensity of the primary
     * color component.  
//       * @deprecated This function does not correctly override the JDK
//       * 1.2 java.awt.Color constructor with the same type/number of
//       * arguments.  It should be OMColor(float r, float g, float b, float a).
     ...
     * the color in the default RGB ColorModel.  The alpha, red,
     * green, and blue components of the color are each scaled to be a
     * value between 0 (abscence of the color) and 255 (complete
    ...
    /**
     * Return the red value of the color (the value of the
     * 16-23 bits). 
    ...
    /**
     * Return the green value of the color (the value of the
     * 8-15 bits). 
    ...
    /**
     * Return the blue value of the color (the value of the
     * 0-7 bits). 
    ...
    /**
     * Return a color value that has the transparency alpha value
     * set to a percentage value between 0.0 and 1.0.
     *
     ...
     * The alpha bits (31-24) of the color determine this.
     ...
     * alpha, red, green, and blue values as this object. 
