 ...
 * graphic type, it is ignored. <p>
 *
 * The OMGraphics are being updated to be able to provide
 * java.awt.Shape representations of themselves after they have been
 * generated().  The getShape() method returns a java.awt.Shape
 * object.  With the Shape object, you can do some spatial analysis
 * (object operations) on the projected OMGraphics.
 *
 * NOTES:
 * <ul>
...
public abstract class OMGraphic extends BasicGeometry
  ...
  //////////////////////////////////////////////////////////  
     ...
     * should be drawn showing where the original position is.  <P>
     ...
     * paint of the graphic.  This Paint is used as the display Paint
     * when the object IS selected (hightlighted). The display
     * Paint is set to the select Paint in this method if
     ...
     * in the present selected state.  If the displayPaint is not a
     ...
     * will be rendered on top of the fill paint.  If the fill paint
     * is clear, the texture mask will not be used.  If you just want
     * to render the texture mask as is, set the fill paint of the
...
//////////////////////////////////////////////////////////////////////////
     ...
     * generated, it will not be rendered. <P>
     *
