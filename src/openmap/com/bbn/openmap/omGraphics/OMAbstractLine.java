...
public abstract class OMAbstractLine extends OMGraphic {
  ...
  /**
   * Construct an OMAbstractLine. Standard simple constructor that the
   * child OMAbstractLine usually call. All of the other parameters get
  ...
  /**
   * Construct an OMAbstractLine. More complex constructor that lets you
