...
public class OMScalingRaster extends OMRaster implements Serializable {
	 ...
	 * 
	 * @param ullat
	 *            latitude of the top of the image.
	 * @param ullon
	 *            longitude of the left side of the image.
	 * @param lrlat
	 *            latitude of the bottom of the image.
	 * @param lrlon
	 *            longitude of the right side of the image.
	 * @param w
	 *            width of the image, in pixels.
	 * @param h
	 *            height of the image, in pixels.
	 * @param pix
	 *            color values for the pixels.
	 */
	 ...
	 *            height of the image, in pixels.
	 * @param bytes
	 *            colortable index values for the pixels.
	 * @param colorTable
	 *            color array corresponding to bytes
	 * @param trans
	...
	public void setImage(Image image) {
		...
		if (!(image instanceof BufferedImage)) {
			sourceImage = new BufferedImage(image.getWidth(this), image
	 ...
	 * 
	 * @param thisProj
	 *            the projection that the image should be scaled to.
	 */
	protected void scaleTo(Projection thisProj) {
		...
		// Assume we will not see it, in order to see if any part of the
		...
		if (!iRect.isEmpty()) {
			...
			if ((iRect.width >= 1) && (iRect.height >= 1)) {
				...
				if (!winRect.contains(projRect)) {
					...
					// Make sure the rounding doesn't exceed the original icon
					// bounds
