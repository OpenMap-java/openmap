...
public class StandardMapMouseInterpreter
   ...
   public class GeometryOfInterest {
      ...
      /**
       * A check to see if a mouse event that is occurring over an OMGraphic is
       * infact occurring over the one of interest, and with the same mouse
       * button.
       */
    ...
    * MapMouseListeners will not receive the events. If false, lower layers will
    * also receive events, which will let them react too. Intended to let other
    * layers provide information about what the mouse is over when editing is
    * occurring.
    */
   ...
   /**
    * Set the GeometryOfInterest as one that could possibly be in the process of
    * being clicked upon.
    */
   ...
   /**
    * Get the GeometryOfInterest as one that could possibly be in the process of
    * being clicked upon.
    */
    ...
    * when the testForAndHandlePopupTrigger method is called in mousePressed and
    * mouseReleased.
    * 
    * @param e MouseEvent
    ...
    * 
    * @param e MouseEvent
    * @return the result from mouseMoved (also called from this method) combined
    *         with the consumeEvents setting.
    */
    ...
    * 
    * @param e MouseEvent
    * @return the result of updateMouseMoved() if the timer isn't being used, or
    *         false.
    */
   ...
   /**
    * Notify the GRP that the OMGraphic has been deselected. Wraps the OMGraphic
    * in an OMGraphicList.
    */
