...
public class EditableOMRangeRings extends EditableOMCircle {
    ...
    // OMRangeRingsLoader (OMCircleLoader), and I don't think we have a handle
    // to
    ...
    private int getInterval() {
        return (!isNewRing()) ? ((OMRangeRings) circle).getInterval()
                : haveUserSpecifiedValue() ? lastInterval : OMRangeRings.DEFAULT_INTERVAL;
    }
    ...
    /**
     * Create an UndoEvent that can get an OMRangeRing back to what it looks
     * like right now.
     */
     ...
     * @author ddietrick
     */
    public static class OMRangeRingUndoEvent extends OMGraphicUndoEvent implements UndoEvent {
