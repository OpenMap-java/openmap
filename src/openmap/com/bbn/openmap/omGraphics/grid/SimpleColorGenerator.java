 ...
 * OMRaster out of OMGrid data. The OMgrid data is assumed to be color
 * ARGB integer values. Each pixel is colored according to the closest
 * grid data point value.
 */
public class SimpleColorGenerator implements OMGridGenerator {
     ...
     * location in the grid, and gives a color to paint the pixel. In
     * this case, the grid point value IS the color value.
     * 
    ...
    /*
     * This method creates a set of greyscale colors. It isn't used in
     * the parent SimpleColorGenerator, but it probably will be used
     * in extended classes.
     * 
     * @param num_colors the number of greys needed. @param opaqueness
     * how clear the color should be (0-255, where 0 is clear).
