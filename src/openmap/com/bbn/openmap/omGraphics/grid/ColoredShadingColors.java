...
public class ColoredShadingColors implements ElevationColors { 
    ...
    public final int[] DEFAULT_COLOR_CUTOFFS = {0, 50, 100, 200, 400, 800, 1200, 1600, 2000, 3000, 4000, 6000, 8000, 10000, 12000, 33000};

    public final int[] DEFAULT_COLORS = {0x00bfeffa, 0xff145f46, 0xff286650, 0xff3c8064, 0xff6e9982, 0xff8caf96, 0xffbec896, 0xffe1c89b, 0xffb39e4d, 0xff9f8e33, 0xffa39833, 0xffb2a54d, 0xffb9a570, 0xffd7cd8c, 0xffd9d9d9, 0xfff3f3e6};
    ...
    public int getARGB(int elevation, Length units, double slope) {
        ...
        while (colors != null && i < numCutoffs 
               && colors[i] != null && colors[i].height < elev) {
            i++;
        }
