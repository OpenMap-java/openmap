...
//      public final static Cursor EDIT = create("edit.gif", new Point(0, 0), "EOMG_EDIT");
//      public final static Cursor PUTNODE = create("putnode.gif", new Point(0, 0), "EOMG_PUTNODE");
//      public final static Cursor MOVE = create("move.gif", new Point(8, 8), "EOMG_MOVE");

//      public final static Cursor EDIT = Cursor.getPredefinedCursor(Cursor.MOVE_CURSOR);
//      public final static Cursor PUTNODE = Cursor.getPredefinedCursor(Cursor.MOVE_CURSOR);
//      public final static Cursor MOVE = Cursor.getPredefinedCursor(Cursor.HAND_CURSOR);
//      public final static Cursor GRAB = Cursor.getPredefinedCursor(Cursor.HAND_CURSOR);
