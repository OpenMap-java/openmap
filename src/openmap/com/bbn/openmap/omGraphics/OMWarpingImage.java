...
public class OMWarpingImage extends OMGraphic {
     ...
     */
    public OMWarpingImage(String imagePath) throws MalformedURLException,
     ...
     * @throws InterruptedException
     */
    public OMWarpingImage(String imagePath, GeoCoordTransformation transform,
            DataBounds imageBounds) throws MalformedURLException,
            InterruptedException {
     ...
     */
    public OMWarpingImage(String imagePath, GeoCoordTransformation transform,
            WorldFile worldfile) throws MalformedURLException,
            InterruptedException {
     ...
     * @throws InterruptedException
     */
    public OMWarpingImage(BufferedImage bi, GeoCoordTransformation transform,
     ...
     * @throws InterruptedException
     */
    public void setWarp(String imagePath, GeoCoordTransformation transform,
                        DataBounds imageBounds) throws MalformedURLException,
            InterruptedException {
