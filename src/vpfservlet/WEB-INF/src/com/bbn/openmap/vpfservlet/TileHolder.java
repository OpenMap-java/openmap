...
public class TileHolder {
     ...
     * @param isTiled if the coverage is tiled or not.  If it is, tiling
     * information is assumed to be located in $basepath/../tileref
     ...
     * @param path the path to the coverage.  tiling info is in ../tileref
