...
/**
 * An Iterator subclass that wraps another iterator.  Each element returned by
 * the iterator is the result of calling Applyable.apply() on the current
 * element of the underlying iterator.
 */
